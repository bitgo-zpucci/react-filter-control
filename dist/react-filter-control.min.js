(function (global, factory) {
  ...
  */
  ...
  const AddButton = ({
    ...
    className: "fc-button-color-secondary fc-group-button-icon fc-button-add",
    onClick: onClick,
    tabIndex: "0",
    "aria-label": "New Filter",
    role: "button"
  }, React__default.createElement("span", null, "New Filter"));
  ...
  const Menu = ({
    ...
    return React__default.createElement("div", {
      className: `fc-dropdownmenu-contextmenu-item${(index === activeIndex) ? " active" : ""}`,
  ...
  class DropDownMenu extends React.Component {
    ...
    render() {
      ...
      return React__default.createElement("span", {
        ...
        text: textField ? (menuItems[activeIndex] ? menuItems[activeIndex][textField] : "Select") : menuItems[activeIndex],
        color: color,
        onClick: this.handleButtonClick
  ...
  const Condition = ({
    ...
    const getActiveField = conditionValue => {
      ...
      const activeOptionIndex = (activeField.options || []).findIndex(option => option.value === conditionValue.value);
      return {
        index,
        activeOperatorIndex,
        activeOptionIndex,
        ...
        transformValue: activeField.transformValue,
    ...
    const updateCondition = (propertyName, newValue) => {
      ...
      if (propertyName === "value") {
        ...
        conditionValue.transformValue = activeField.transformValue;
      }
    ...
    const handleOptionChanged = newValue => onConditionValueChanged(updateCondition('value', newValue));
    ...
    }), (activeField.options && activeField.type === "select") ? React__default.createElement(DropDownMenu, {
      textField: "caption",
      color: "primary",
      keyField: "value",
      activeIndex: activeField.activeOptionIndex,
      menuItems: activeField.options,
      onMenuItemClick: handleOptionChanged
    }) : React__default.createElement(Consumer, null, consumer => React__default.createElement(consumer.Input, {
      value: activeField.value,
      onChange: handleValueChanged,
      type: (activeField.type === "string") ? "text" : activeField.type,
      placeholder: activeField.placeholder
  ...
  const FilterGroupSettingsRow = ({
    ...
    }, React__default.createElement(value.AddButton, null))), removeClick && React__default.createElement(Consumer, null, consumer => React__default.createElement(consumer.RemoveButton, {
      onClick: removeClick
    })));
  };
